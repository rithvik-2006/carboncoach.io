...
export function AISustainabilityInsights({ initialInsight }: { initialInsight: string | null }) {
    ...
    <Card className="border-emerald-500/20 shadow-sm bg-emerald-500/5 backdrop-blur-sm relative overflow-hidden">
      ...
      <CardHeader className="pb-3 flex flex-row items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-lg text-emerald-700 dark:text-emerald-400">AI Sustainability Insights</CardTitle>
        </div>
      ...
      <CardContent>
        {insight ? (
          ...
          <p className="text-sm text-muted-foreground relative z-10">
            No insights available yet. Log an activity to generate one!
          </p>
        )}
      </CardContent>
    </Card>
